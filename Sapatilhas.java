...
public class Sapatilhas extends Artigo{
    ...
    private double desconto(){
        if(this.getPremium()){
            ...
            return getPreco_base()*0.1*diferencaAnos;
        }else{
